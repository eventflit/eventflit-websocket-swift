...
public enum EventflitHost {
    ...
    public var stringValue: String {
        switch self {
            ...
            case .cluster(let cluster): return "ws-\(cluster).eventflit.com"
        }
    }
}
...
@objcMembers
@objc public class EventflitClientOptions: NSObject {
    ...
    @nonobjc public init(
        ...
        host: EventflitHost = .host("service.eventflit.com"),
        port: Int? = nil,
        encrypted: Bool = true,
