...
@objcMembers
@objc open class GlobalChannel: EventflitChannel {
    ...
    */
    init(connection: EventflitConnection) {
        super.init(name: "eventflit_global_internal_channel", connection: connection)
    }
